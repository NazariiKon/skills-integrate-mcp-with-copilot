...
with open(teachers_file, "r") as f:
    ...
    teacher_credentials = {t["username"]: t["password"] for t in teachers_data["teachers"]}

# In-memory session store (maps session_id to username)
sessions = {}
...
@app.get("/auth-status")
def check_auth(session_id: str = Query(None)):
